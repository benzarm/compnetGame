...
def actionOutcome(actionCode, userName, enemyName):
	...
	if(userCode == "A")	#fighter
		...
		if(actionCode == 'C1S'):
			...
			if(comm == 1):
				print("With a blazing arrow, you hear the searing strike wound " + enemyName + "! ...\n")
			if(comm == 2):
				print("With a smoke trail behind it, a flaming blast greatly harms your enemy...\n")
			if(comm == 3):
				print("With crackles of heat and a zipping sound, you hear" + enemyName + "exclaim in pain from your flaming shot...\n")		#	#	#DONE
		elif(actionCode == 'C2F'):
			if(comm == 1):
				print("As the flaming arrow zips by, your enemy evades your shot...\n")
			if(comm == 2):
				print("With a hiss, the ground where the arrow hit sizzles as you miss your shot...\n")
			if(comm == 3):
				print("With the weighty head of the arrow, the flaming arrow flails and you miss your target...\n")	#DONE
		elif(actionCode == 'C3S'):
			if(comm == 1):
				print("With a deft tuck and roll, you quickly dodge your enemy's advance...\n")
			if(comm == 2):
				print("With an agile roll, you dodge " + enemyName + "'s advance! ...\n")
			if(comm == 3):
				print("Adrenaline and energy pump through your veins as you jump to the side to dodge the enemy's attack...\n")	#DONE
		elif(actionCode == 'C3F'):
			if(comm == 1):
				print("After an attempt to escape the attack, " + enemyName + " caught your intentions and prevented you from dodging...\n")
			if(comm == 2):
				print("With a grin, " + enemyName + " spits at you and yells: you can't run away, " + userName + "! ...\n")
			if(comm == 3):
				print("With a failed dodge, you take the consequences of your mistake...\n")		#DONE
